...
from admin_tools.dashboard import modules, Dashboard, AppIndexDashboard as AppIndexDashboardBase
...
class AppIndexDashboard(AppIndexDashboardBase):
    """
    ...
    def __init__(self, *args, **kwargs):
        AppIndexDashboardBase.__init__(self, *args, **kwargs)
